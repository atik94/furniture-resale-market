...
const AddProducts = () => {
  ...
  return (
    <div className="w-96 p-7 mx-auto">
      <h2 className="text-5xl text-indigo-400 mb-5">Add a products</h2>
      <form onSubmit={handleSubmit(handleAddProducts)}>
        ...
        <select
          className="select input-bordered w-full max-w-xs mt-2"
        ...
        <input className="btn bg-indigo-400 w-full mt-4" value="Add Product" type="submit" />
      </form>
    </div>
  );
};
